...
# Collect all arguments for the java command, stracks://issues.gradle.org/browse/GRADLE-2067
# For Darwin we add an additional -D to ensure files are created with UTF-8, see
if "$darwin"; then
